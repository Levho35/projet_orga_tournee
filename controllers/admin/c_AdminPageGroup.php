...
class AdminPageGroup
{
    ...
    function __construct()
    {
        ...
        $this->selectIdGroup = $groupId;

    }

    function printGroupName(){
        echo '<h1 class="h1_interne" id="FocusSwimmingPool--Title">' . $this->selectGroup->getName() . '</h1>';
    }
    ...
    function printArtist()
    {
        foreach ($this->artists as $artist) {
            echo '<tr>
                ...
                <td> <button class="adminTableAction nameEvidence" type="submit">'. $artist->getName() . '</td>
                </form>
    ...
    function printAddConcert(){
        ...
        <input type="text" style="width:50%" name="date" id="date" value="0000-00-00" required>
        <br><br>
        <input type="hidden" name="id_group" value="' . $this->selectGroup->getIdGroup() . '">
        <input type="hidden" name="action" value="adminRedirection" >
