...
class AdminPageArtist
{
    ...
    function __construct()
    {
        ...
        $this->selectGroupArtist = $artistPDO->getIdGroup($artistId);
        echo "<script>console.log('artist ID groupe: $selectGroupArtist');</script>";
        $this->selectIdArtist = $artistId;
        echo "<script>console.log('artist ID groupe: $selectGroupArtist');</script>";
    }

    function printArtistName(){
        echo '<h1 class="h1_interne" id="FocusSwimmingPool--Title">' . $this->selectArtist->getName() . '</h1>';
    }
