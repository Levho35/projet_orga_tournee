...
<main>
    ...
    <div class="divInvisible divAdminOption" id="addArtist">
        <h1 class="h1_interne">Ajouter un artiste</h1>
        <?php $ControllerAdminPageGroup->printAddArtist(); ?>
        <form method="POST" action="index.php">
            <input type="hidden" name="action" value="adminRedirection" >
            <input type="hidden" name="step" value="pageGroup" >
            <input type="hidden" name="groupId" value="<?php echo $ControllerAdminPageGroup->selectIdGroup; ?>">
    ...
    <div class="divInvisible divAdminOption" id="addConcert">
        <h1 class="h1_interne">Ajouter un concert</h1>
